...
C *                                                                     * C
C * THIS ROUTINE RETURNS THE COEFFICIENTS OF THE GENERALIZED GEGENBAUER * C
C * ADDITION THEOREM.                                                   * C
C *                                                                     * C
C * INPUT :                                                             * C
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      SUBROUTINE GEGEN0(LMDL12, NL2, ZETA2, AB, RLEG01, RLEG02, RLEAG0,
     $                                             BESF01, X4NL, GEGIN0)
...
C.... POLYNOMIALS FOR EACH ROOT OF THE GAUSS-LEGENDRE QUADRATURE
     ...
     $                     RLEAG0,IN,LEG00, BESF01, X4NL, HEREX, BESS01)

C.... COMPUTATION OF THE DERIVATIVES OF THE PRODUCT OF THE MODIFIED
C.... BESSEL FUNCTIONS OVER THE RANGE [0, AB]
