...
C *                                                                     * C
C * THIS ROUTINE RETURNS THE TWO-CENTER TWO-ELECTRON COULOMB INTEGRALS  * C
C * NEEDED IN THE SCF PROCEDURE. IT IS CALLED FROM THE TOELEC ROUTINE.  * C
C *                                                                     * C
C * INPUT :                                                             * C
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      SUBROUTINE TCCIS(NEPSIL, NTORB,NSUM, LM123, IC1,IC2, NORBAT,
...
ccc   WRITE(*, 1)IC1, IC1, IC2, IC2
c1    FORMAT('TCCIS : ', 4(I2, 2X))


C.... COMPUTATION OF THE COORDINATE OF THE CENTER LABELED IC2 TO WHICH THE
C.... ORBITALS X3(2) AND X4(2) ARE ATTACHED
...
C.... COMPUTATION OF THE TWO-CENTER TWO-ELECTRON COULOMB INTEGRALS

      CALL TCCI(NEPSIL, NTORB,NSUM, LM123, NORBAT(IC1),NORBAT(IC2),
